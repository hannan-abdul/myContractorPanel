...
import { getSingleJobCat, updateJobCategory } from '../../services/Job';
import Select from 'react-select';
import "./style.scss";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faTimesCircle } from '@fortawesome/free-regular-svg-icons';

const EditJobCat = ({ id, closeModal, closeEdit, value }) => {
    const [names, setNames] = React.useState('');
    const [loading, setLoading] = React.useState(false);
    const [detail, setDetail] = React.useState([]);
    const [material, setMaterial] = React.useState([]);
    const [propertysize, setPropertysize] = React.useState([]);
    const { name, details, materials, propertySize } = value;
        ...
        <React.Fragment>
            ...
            >
                <div className="modal-header">
                    <h5 className="modal-title h2">Edit Category</h5>
                ...
                <ModalBody>
                    ...
                    <FormGroup row className="tag-container">
                ...
                <ModalFooter>
                    <Button color="secondary" onClick={() => { id ? closeEdit(false) : closeModal(false) }}>
                        Close
                    </Button><Button color="brand" onClick={EditJob}>
                        {
